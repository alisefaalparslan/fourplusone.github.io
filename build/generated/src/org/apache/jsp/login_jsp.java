  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      synchronized (session) {
        user = (data.User) _jspx_page_context.getAttribute("user", PageContext.SESSION_SCOPE);
        if (user == null){
          user = new data.User();
      ...
      out.write("\n");
      out.write("    ");
      data.DBLayer db = null;
      synchronized (session) {
        db = (data.DBLayer) _jspx_page_context.getAttribute("db", PageContext.SESSION_SCOPE);
        if (db == null){
          db = new data.DBLayer();
